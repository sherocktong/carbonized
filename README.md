...
<div class="highlighter-rouge"><pre class="highlight"><code>let g:carbonized_dark_CursorLineNr = 'off'
...
<div class="highlighter-rouge"><pre class="highlight"><code>let g:carbonized_dark_LineNr = 'off'
