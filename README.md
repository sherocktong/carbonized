...
<p>carbonized consists of 8 theme-distinct <strong>base colours</strong> and 8 nightsense-theme-standard <strong>accent colours</strong>, the latter used for syntax highlighting.</p>
