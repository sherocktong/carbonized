...
<ul>
  <li>disable highlighting of current line number: <code class="highlighter-rouge">let g:carbonized_dark_CursorLineNr = 'off'</code>, <code class="highlighter-rouge">let g:carbonized_light_CursorLineNr = 'off'</code></li>
</ul>
